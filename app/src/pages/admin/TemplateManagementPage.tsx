    ...
    <div className="max-w-[1400px] mx-auto px-6 pt-5 pb-10">
      <div className="flex items-center justify-between text-[12px] mb-5">
        <nav className="text-neutral-500">
          ...
          <span className="text-ink-950 font-semibold">TemplateManagement</span>
        </nav>
      </div>
      <div className="card p-6">
        <h1 className="font-display font-bold text-[20px] text-ink-950">TemplateManagement Data</h1>
