...
// ============================================================================
// Gas Systems Operators & Contractors — REGISTRATION CANCELLATION
// Source: SDD §3 (Cancellation of Gas System Company Registration)
//
// Slim form: Cancellation Reason (mandatory) + Supporting Documents (optional).
// Three-tier review then payment. On payment a Cancellation document is
// generated; the original Registration is moved to Cancelled with the
// expiry set to the final approval date.
// ============================================================================

export const gasCancelService: ServiceDefinition = {
  id: 'gas.cancel',
  module: 'gas',
  action: 'cancel',
  title: 'Cancellation of Gas System Company Registration',
  shortTitle: 'Gas Cancel',
  description:
    'Cancel an active Gas System Company Registration. Reason and optional supporting documents → three-tier review → cancellation document.',
  initialState: 'draft',
  feeAmount: 1000,
  ...
  form: [
    {
      ...
      description: 'Pre-populated from the active Registration Certificate being cancelled.',
      fields: [
    ...
    },
    {
      ...
      fields: [
        { id: 'cancellationReason', label: 'Cancellation Reason', type: 'textarea', required: true, remark: 'Mandatory — explain why this registration should be cancelled.' },
      ],
      attachments: [
  ...
  notifications: [
    { id: 'ack-applicant',                channel: 'email', to: 'applicant',    subject: 'Cancellation of Gas System Company Registration — Application Received (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nWe confirm receipt of your application for the Cancellation of Gas System Company Registration submitted via the DOE Unified Service Portal.\n\nApplication Reference: %ApplicationNumber%\nStatus: Under Review\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'notify-engineer',              channel: 'email', to: 'engineer',     subject: 'Review Required — Cancellation of Gas System Company Registration — %CompanyName%', body: 'Dear PPS Engineer,\n\n%CompanyName% has submitted a request for the Cancellation of their Gas System Company Registration.\nApplication Reference: %ApplicationNumber%.\n\nPlease log in to the DOE Unified Service Portal to review the application.\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'return-applicant',             channel: 'email', to: 'applicant',    subject: 'Cancellation of Gas System Company Registration — More information required (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nAdditional information is required for your Cancellation application (Ref: %ApplicationNumber%).\n\nComments: %Comments%\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'notify-section-head',          channel: 'email', to: 'section_head', subject: 'Application Awaiting Approval — Cancellation of Gas System Company Registration — %CompanyName%', body: 'Dear Section Head,\n\nThe Cancellation application from %CompanyName% has been endorsed by the PPS Engineer.\nApplication Reference: %ApplicationNumber%\n\nBest regards,\nDepartment of Energy — PPS Team' },
    ...
    { id: 'notify-director',              channel: 'email', to: 'director',     subject: 'Application Awaiting Approval — Cancellation of Gas System Company Registration — %CompanyName%', body: 'Dear Director,\n\nThe Cancellation application from %CompanyName% has been endorsed and is awaiting your final decision.\nApplication Reference: %ApplicationNumber%\n\nBest regards,\nDepartment of Energy — PPS Team' },
    ...
    { id: 'reject-applicant',             channel: 'email', to: 'applicant',    subject: 'Rejection — Cancellation of Gas System Company Registration (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nWe regret to inform you that your Cancellation application has been rejected.\n\nApplication Reference: %ApplicationNumber%\nReason: %Comments%\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'approve-applicant',            channel: 'email', to: 'applicant',    subject: 'Application Approved — Payment Pending — Cancellation of Gas System Company Registration (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nYour Cancellation application has been approved. Kindly complete the cancellation processing fee via the DOE Unified Service Portal to receive the Cancellation document.\n\nApplication Reference: %ApplicationNumber%\nStatus: Approved — Payment Pending\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'fee-paid',                     channel: 'email', to: 'applicant',    subject: 'Cancellation Document Issued — Gas System Company Registration (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nYour Cancellation has been processed. The Cancellation document (with QR code and DOE stamp) is now available in your DOE Unified Service Portal account. The original Registration has been moved to Cancelled status.\n\nApplication Reference: %ApplicationNumber%\n\nBest regards,\nDepartment of Energy — PPS Team' },
  ],
