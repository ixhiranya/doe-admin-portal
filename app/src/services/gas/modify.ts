...
// ============================================================================
// Gas Systems Operators & Contractors — REGISTRATION MODIFICATION
// Source: SDD §2 (Modification of Gas System Company Registration)
//
// Available only on an ACTIVE Registration (not expired, cancelled, revoked
// and not currently in another open workflow). Modified fields are visually
// highlighted for the DOE reviewer. Category upgrades trigger manpower /
// reference-project re-validation against the new category.
// ============================================================================

export const gasModifyService: ServiceDefinition = {
  id: 'gas.modify',
  module: 'gas',
  action: 'modify',
  title: 'Modification of Gas System Company Registration',
  shortTitle: 'Gas Modify',
  description:
    'Modify an active Gas System Company Registration — change scope, category, staff, or other details on the existing record.',
  initialState: 'draft',
  feeAmount: 3000,
  ...
  form: [
    {
      ...
      description: 'Pre-populated from the latest issued Registration. Changes are highlighted for the DOE reviewer. Category upgrade triggers manpower / project re-validation.',
      fields: [
        {
          id: 'category',
          ...
          remark: 'Editable. Category upgrades require updated manpower & reference projects.',
        },
    ...
    },
    {
      ...
      description: 'Pre-populated. Add or update technical staff; category upgrades require meeting the new manpower minimums.',
      fields: [],
      repeatable: {
  ...
  notifications: [
    { id: 'ack-applicant',                channel: 'email', to: 'applicant',    subject: 'Modification of Gas System Company Registration — Application Received (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nWe confirm receipt of your application for the Modification of Gas System Company Registration submitted via the DOE Unified Service Portal.\n\nApplication Reference: %ApplicationNumber%\nStatus: Under Review\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'notify-engineer',              channel: 'email', to: 'engineer',     subject: 'Review Required — Modification of Gas System Company Registration — %CompanyName%', body: 'Dear PPS Engineer,\n\n%CompanyName% has submitted a request for the Modification of Gas System Company Registration.\nApplication Reference: %ApplicationNumber%.\n\nPlease log in to the DOE Unified Service Portal to review the application and take the appropriate action.\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'return-applicant',             channel: 'email', to: 'applicant',    subject: 'Modification of Gas System Company Registration — More information required (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nAdditional information is required for your Modification application (Ref: %ApplicationNumber%).\n\nComments: %Comments%\n\nPlease log in to the portal, update the details and re-submit.\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'notify-section-head',          channel: 'email', to: 'section_head', subject: 'Application Awaiting Approval — Modification of Gas System Company Registration — %CompanyName%', body: 'Dear Section Head,\n\nThe application submitted by %CompanyName% for the Modification of Gas System Company Registration has been reviewed and endorsed by the PPS Engineer.\nApplication Reference: %ApplicationNumber%\n\nBest regards,\nDepartment of Energy — PPS Team' },
    ...
    { id: 'notify-director',              channel: 'email', to: 'director',     subject: 'Application Awaiting Approval — Modification of Gas System Company Registration — %CompanyName%', body: 'Dear Director,\n\nThe Modification application from %CompanyName% has been reviewed and endorsed and is awaiting your final decision.\nApplication Reference: %ApplicationNumber%\n\nBest regards,\nDepartment of Energy — PPS Team' },
    ...
    { id: 'reject-applicant',             channel: 'email', to: 'applicant',    subject: 'Rejection — Modification of Gas System Company Registration (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nWe regret to inform you that your application for the Modification of Gas System Company Registration has been rejected.\n\nApplication Reference: %ApplicationNumber%\nReason: %Comments%\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'approve-applicant',            channel: 'email', to: 'applicant',    subject: 'Application Approved — Payment Pending — Modification of Gas System Company Registration (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nYour Modification application has been approved by the Department of Energy.\nApplication Reference: %ApplicationNumber%\nStatus: Approved — Payment Pending\n\nKindly complete the modification fee payment via the DOE Unified Service Portal.\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'fee-paid',                     channel: 'email', to: 'applicant',    subject: 'Payment Received — Modification of Gas System Company Registration (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nThe modification fee for %ApplicationNumber% has been received. The modified Registration Certificate is now available for download.\n\nBest regards,\nDepartment of Energy — PPS Team' },
  ],
