...
// ============================================================================
// HOE / TPI — REGISTRATION REVOCATION (DOE-initiated)
// Source: "HOE TPI Registration Enhancements SDD" §4 (Revocation by DOE)
//
// DOE-internal flow. Initiated by the PPS Engineer against a registered TPI
...
// Two-tier review:  Section Head → Director. No applicant fee.
// ============================================================================

export const hoeRevokeService: ServiceDefinition = {
  id: 'hoe.revoke',
  module: 'hoe',
  action: 'revoke',
  title: 'Revocation of HOE (TPI) Registration',
  shortTitle: 'HOE Revoke',
  description:
    'DOE-initiated revocation of an active Third Party Inspection Company Registration.',
  ...
  form: [
    {
      ...
      description: 'The active TPI Registration this Revocation is being initiated against.',
      fields: [
    ...
    },
    {
      ...
      description: 'Provide the regulatory basis for revoking this TPI Registration. Attach supporting evidence if available.',
      fields: [
  ...
  notifications: [
    { id: 'notify-section-head',         channel: 'email', to: 'section_head', subject: 'Revocation Awaiting Approval — HOE (TPI) Registration — %CompanyName%', body: 'Dear Section Head,\n\nA Revocation has been initiated against %CompanyName% by the PPS Engineer.\nApplication Reference: %ApplicationNumber%\n\nBest regards,\nDepartment of Energy — PPS Team' },
    ...
    { id: 'notify-director',             channel: 'email', to: 'director',     subject: 'Revocation Awaiting Final Approval — HOE (TPI) Registration — %CompanyName%', body: 'Dear Director,\n\nThe Revocation against %CompanyName% has been endorsed by the Section Head.\nApplication Reference: %ApplicationNumber%\n\nBest regards,\nDepartment of Energy — PPS Team' },
    ...
    { id: 'revoked-applicant',           channel: 'email', to: 'applicant',    subject: 'Notice of Revocation — HOE (TPI) Registration (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nThis is to inform you that the Department of Energy has revoked your HOE (TPI) Registration.\n\nApplication Reference: %ApplicationNumber%\nReason: %Comments%\n\nThe Revocation document (with QR code and DOE stamp) is available in your DOE Unified Service Portal account.\n\nBest regards,\nDepartment of Energy — PPS Team' },
  ],
