...
// ============================================================================
// HOE / TPI — REGISTRATION RENEWAL
// Source: "HOE TPI Registration Enhancements SDD" §1 (Renewal)
//
// Available within one month of expiry (or during the post-expiry grace
// period). Pre-populated editable form, three-tier review, payment,
// re-issuance of the TPI Pre-Qualification Certificate.
// ============================================================================

export const hoeRenewService: ServiceDefinition = {
  id: 'hoe.renew',
  module: 'hoe',
  action: 'renew',
  title: 'Renewal of HOE (TPI) Registration',
  shortTitle: 'HOE Renew',
  description:
    'Renew an active Third Party Inspection Company Registration across the applicable Pre-Qualification Categories.',
  initialState: 'draft',
  feeAmount: 4500,
  ...
  form: [
    {
      ...
      description: 'Pre-populated from the latest issued TPI Registration. Editable fields can be updated; identity fields stay read-only.',
      fields: [
        {
          id: 'category',
          ...
          remark: 'Editable. Adding a new category triggers an engineer-count re-validation against that category.',
        },
    ...
    },
    {
      ...
      description: 'Pre-populated. You can add or remove engineers. Minimum 2 engineers per category with ≥10 years gas-utilization experience.',
      fields: [],
      repeatable: {
        itemLabel: 'Engineer',
  ...
  notifications: [
    { id: 'ack-applicant',                channel: 'email', to: 'applicant',    subject: 'Renewal of HOE (TPI) Registration — Application Received (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nWe confirm receipt of your application for the Renewal of HOE (TPI) Registration.\n\nApplication Reference: %ApplicationNumber%\nStatus: Under Review\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'notify-engineer',              channel: 'email', to: 'engineer',     subject: 'Review Required — Renewal of HOE (TPI) Registration — %CompanyName%', body: 'Dear PPS Engineer,\n\n%CompanyName% has submitted a request for the Renewal of HOE (TPI) Registration.\nApplication Reference: %ApplicationNumber%.\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'return-applicant',             channel: 'email', to: 'applicant',    subject: 'Renewal of HOE (TPI) Registration — More information required (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nAdditional information is required for your Renewal application (Ref: %ApplicationNumber%).\n\nComments: %Comments%\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'notify-section-head',          channel: 'email', to: 'section_head', subject: 'Application Awaiting Approval — Renewal of HOE (TPI) Registration — %CompanyName%', body: 'Dear Section Head,\n\nThe Renewal application from %CompanyName% has been endorsed by the PPS Engineer.\nApplication Reference: %ApplicationNumber%\n\nBest regards,\nDepartment of Energy — PPS Team' },
    ...
    { id: 'notify-director',              channel: 'email', to: 'director',     subject: 'Application Awaiting Approval — Renewal of HOE (TPI) Registration — %CompanyName%', body: 'Dear Director,\n\nThe Renewal application from %CompanyName% has been endorsed and is awaiting your final decision.\nApplication Reference: %ApplicationNumber%\n\nBest regards,\nDepartment of Energy — PPS Team' },
    ...
    { id: 'reject-applicant',             channel: 'email', to: 'applicant',    subject: 'Rejection — Renewal of HOE (TPI) Registration (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nYour Renewal application has been rejected.\n\nApplication Reference: %ApplicationNumber%\nReason: %Comments%\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'approve-applicant',            channel: 'email', to: 'applicant',    subject: 'Application Approved — Payment Pending — Renewal of HOE (TPI) Registration (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nYour Renewal application has been approved. Please complete the renewal fee payment via the DOE Unified Service Portal to receive the renewed Certificate.\n\nApplication Reference: %ApplicationNumber%\nStatus: Approved — Payment Pending\n\nBest regards,\nDepartment of Energy — PPS Team' },
    { id: 'fee-paid',                     channel: 'email', to: 'applicant',    subject: 'Payment Received — Renewal of HOE (TPI) Registration (Ref: %ApplicationNumber%)', body: 'Dear %CompanyName%,\n\nThe renewal fee for %ApplicationNumber% has been received. The renewed Pre-Qualification Certificate is now available for download.\n\nBest regards,\nDepartment of Energy — PPS Team' },
  ],

  sla: [
    { stage: 'Renewal submission window', role: 'applicant',    days: 0 },
